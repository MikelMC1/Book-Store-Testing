...
public class Book implements Serializable {
    ...
    public Book(String ISBN, String author, String title, String book_category,
               String purchased_date, double purchased_price, double selling_price, int stock) throws ISBNnotValidException {
        this.ISBN = ISBN;
        this.author = author;
        this.title = title;
    ...
    public String toString() {
        return "ISBN=" + this.ISBN + "   author=" + this.author + "   title=" + this.title + "   book_category=" + this.book_category + "   purchased_date=" + this.purchased_date + "   purchased_price=" + this.purchased_price + "   stock=" + this.stock + "\n";
    }
}
